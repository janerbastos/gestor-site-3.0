...
from a_Content.forms.link_forms import FactoryATLinkForm
...
@PermissionRequired('create', 'ATLink')
def create_link(request, url):
    ...
    CreateForm = FactoryATLinkForm.get_class('create')
...
@PermissionRequired('update', 'ATLink')
def update_link(request, url):
...
@PermissionRequired('delete', 'ATLink')
def delete_link(request, url):
...
@PermissionRequired('workflow', 'ATLink')
def workflow_link(request, url):
