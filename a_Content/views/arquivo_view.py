...
from a_Content.forms.arquivo_forms import FactoryATArquivoForm
...
@PermissionRequired('create', 'ATArquivo')
def create_arquivo(request, url):
    ...
    CreateForm = FactoryATArquivoForm.get_class('create')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            data['tipo'] = ContentType.ATARQUIVO
...
@PermissionRequired('update', 'ATArquivo')
def update_arquivo(request, url):
    ...
    if request.method == 'POST':
        ...
        form = CreateForm(initial={
            ...
            'arquivo_destaque' : arquivo_data.get('arquivo_destaque')
        })
...
@PermissionRequired('delete', 'ATArquivo')
def delete_arquivo(request, url):
...
@PermissionRequired('workflow', 'ATArquivo')
def workflow_arquivo(request, url):
